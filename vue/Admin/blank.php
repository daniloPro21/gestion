    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Content -->
            <form method="post" action="../../modele/valider.php" >
              <div class="form-group">
             MATRICULE <input type="text" class="form-control" size="10" maxlength="8" name="matricule" placeholder="le matricule de l'employer"><br>
